...
$(document).on('click', '.btn-edit',function(){
	$(this).closest('tr').find('input[name="password"]').attr('disabled', false);
	$(this).closest('tr').find('input[name="mail"]').attr('disabled', false);
...
$(document).on('click', '.btn-confirm',function(){
	$(this).closest('tr').find('input[name="username"]').attr('disabled', true);
	$(this).closest('tr').find('input[name="password"]').attr('disabled', true);
	$(this).closest('tr').find('input[name="mail"]').attr('disabled', true);
...
$('.btn-add-line').on('click', function(){
	...
	$('tbody').append('<tr>'+
					...
					'<td><input type="text" class="form-control input-username" placeholder="Username" name="username"></td>'+
					'<td><input type="text" class="form-control input-password" placeholder="Password" name="password"></td>'+
					'<td>'+
					'<input type="email" class="form-control input-email" placeholder="Mail" name="mail">'+
					'</td>'+
					'<td>'+
